...
class CarSelectDialog extends StatefulWidget {
  final DateTime? date;
  final int gender;
  final String about;
  final List images;
  ...
  @override
  State<CarSelectDialog> createState() => _CarSelectDialogState();
}

class _CarSelectDialogState extends State<CarSelectDialog> {
