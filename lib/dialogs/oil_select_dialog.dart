...
class OilSelectdialog extends StatefulWidget {
  final DateTime? date;
  final int gender;
  final String about;
  final List images;
  ...
  @override
  State<OilSelectdialog> createState() => _OilSelectdialogState();
}

class _OilSelectdialogState extends State<OilSelectdialog> {
